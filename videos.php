...
<p>Clarification: The Brightcove plug-in is for the WordPress.org full installation for hosting your own Web site, NOT for WordPress blog pages hosted on WordPress.com.</p>

<ul>
<li>The Brightcove WordPress plug-in is only supported for single video players, created from player templates, and is not supported for custom players.</li>
<li>The Brightcove WordPress plug-in does not allow for modifications to support single or mulitple playlist players.</li>
<li>Impelimenting the plug-in requires editing the settings .</li>
</ul>

<h5>Using the Plug-in</h5>
